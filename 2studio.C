...
Thmuout->Fill(detKinBeamRot_def_angle_mu,wgt_full);      
    ...
    {
        if(detKinBeamRot_def_angle_mu<1.1)
   ...
   //E3x32CUT->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);
    //Th2->Fill(detKinBeamRot_def_angle_e,detKinBeamRot_def_angle_mu,wgt_full);
         ...
         if(photon_energy!=-1 && n_cell_ph!=0){
                ...
                diff_r_pheCUT->Fill(d_e_ph,wgt_full);} EeoutCUT->Fill(detKinBeamRot_Ee,wgt_full);                 TheoutCUT->Fill(detKinBeamRot_def_angle_e,wgt_full);                  EmuoutCUT->Fill(detKinBeamRot_Emu,wgt_full);                 ThmuoutCUT->Fill(detKinBeamRot_def_angle_mu,wgt_full); diff_r_mueCUT->Fill(r_mue,wgt_full); 
        } else
        {
...
Th2->Fill(detKinBeamRot_def_angle_e,detKinBeamRot_def_angle_mu,wgt_full);
 ...
 diff_r_pheCUTafter->Fill(d_e_ph,wgt_full);}
    ...
    {
         if(detKinBeamRot_def_angle_mu<0.5)
        { /*hist_E3x3_eCUT->Fill(E_clus3x3,wgt_full);
    hist_E9_eCUT->Fill(E9,wgt_full);
    hist_E92_eCUT->Fill(Emean_out,wgt_full);
    hist_Eout_eCUT->Fill(Eout,wgt_full); 
    ...
    //Th2->Fill(detKinBeamRot_def_angle_e,detKinBeamRot_def_angle_mu,wgt_full);
         ...
         if(photon_energy!=-1 && n_cell_ph!=0){
                ...
                ThphoutCUT->Fill(photon_def_angle_ph,wgt_full);
                diff_th_pheCUT->Fill(diffTh,wgt_full);
                diff_r_pheCUT->Fill(d_e_ph,wgt_full);} EeoutCUT->Fill(detKinBeamRot_Ee,wgt_full);                 TheoutCUT->Fill(detKinBeamRot_def_angle_e,wgt_full);                  EmuoutCUT->Fill(detKinBeamRot_Emu,wgt_full);                 ThmuoutCUT->Fill(detKinBeamRot_def_angle_mu,wgt_full); diff_r_mueCUT->Fill(r_mue,wgt_full);  EeoutCUT->Fill(detKinBeamRot_Ee,wgt_full);                 TheoutCUT->Fill(detKinBeamRot_def_angle_e,wgt_full);                  EmuoutCUT->Fill(detKinBeamRot_Emu,wgt_full);                 ThmuoutCUT->Fill(detKinBeamRot_def_angle_mu,wgt_full); diff_r_mueCUT->Fill(r_mue,wgt_full); 
        } else
        {
          /*hist_E3x3_e->Fill(E_clus3x3,wgt_full);
         hist_E9_e->Fill(E9,wgt_full);
...
E3x32CUT->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);
 ...
 diff_r_pheCUTafter->Fill(d_e_ph,wgt_full);}
    ...
    // ZONA 3
    if(detKinBeamRot_def_angle_e>10 && detKinBeamRot_def_angle_e<=13)// E_clus3x3<(20-(10/7)*detKinBeamRot_def_angle_e -- (E_clus3x3<5 && detKinBeamRot_def_angle_e<11)
    {
...
E3x32CUT->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);
 ...
 diff_r_pheCUTafter->Fill(d_e_ph,wgt_full);}
    ...
    // ZONA 4
    if(detKinBeamRot_def_angle_e>13 && detKinBeamRot_def_angle_e<=18.5)// E_clus3x3<(20-(10/7)*detKinBeamRot_def_angle_e -- (E_clus3x3<5 && detKinBeamRot_def_angle_e<11)
    {
 ...
 diff_r_pheCUTafter->Fill(d_e_ph,wgt_full);}
    ...
    //Th2->Fill(detKinBeamRot_def_angle_e,detKinBeamRot_def_angle_mu,wgt_full);
         ...
         if(photon_energy!=-1 && n_cell_ph!=0){
            ...
            EeoutCUT->Fill(detKinBeamRot_Ee,wgt_full);                 TheoutCUT->Fill(detKinBeamRot_def_angle_e,wgt_full);                  EmuoutCUT->Fill(detKinBeamRot_Emu,wgt_full);                 ThmuoutCUT->Fill(detKinBeamRot_def_angle_mu,wgt_full); diff_r_mueCUT->Fill(r_mue,wgt_full); 
        } else
        {
          /*hist_E3x3_e->Fill(E_clus3x3,wgt_full);
         hist_E9_e->Fill(E9,wgt_full);
...
hist_E92_eCUT->Fill(E2nd,wgt_full);
hist_E9_e->Fill(E9,wgt_full);
hist_E9_eCUT->Fill(E9,wgt_full); 
hist_Eout_e->Fill(Eout,wgt_full);
hist_Eout_eCUT->Fill(Eout,wgt_full);*/  
...
Thphout->SetLineColor(kBlack);
Thphout->SetLineWidth(3);
Thphout->Draw("HIST"); 

ThphoutCUT->GetXaxis()->SetTitle("Theta[mrad]");
ThphoutCUT->SetLineColor(kRed);
ThphoutCUT->SetLineWidth(3);
ThphoutCUT->Draw("HIST same"); 
d->cd(3);
diff_th_phe->GetXaxis()->SetTitle("Delta_Theta[mrad]");
diff_th_phe->SetLineColor(kBlack);
diff_th_phe->SetLineWidth(3);
diff_th_phe->Draw("HIST"); 
    
diff_th_pheCUT->GetXaxis()->SetTitle("Delta_Theta[mrad]");
diff_th_pheCUT->SetLineColor(30);
diff_th_pheCUT->SetLineWidth(3);
diff_th_pheCUT->Draw("HIST same"); 
