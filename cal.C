...
c1->SaveAs("/home/LHCB-T3/espedicato/tesi/calE9.png");*/
...
c2->SaveAs("/home/LHCB-T3/espedicato/tesi/caldist.png");
...
c2a->SaveAs("/home/LHCB-T3/espedicato/tesi/calDtheta.png");*/
...
gPad->BuildLegend(0.25,0.15,0.25,0.15);
c4->SaveAs("/home/LHCB-T3/espedicato/tesi/calthEPROFILE.png");   
...
px1->Draw("same");
gPad->BuildLegend(0.25,0.15,0.25,0.15);
cp->SaveAs("/home/LHCB-T3/espedicato/tesi/calthEprofTRUE.png");        
...
c4a->SaveAs("/home/LHCB-T3/espedicato/tesi/calthE.png");
...
E3x3true->Draw("COLZ");
cc->SaveAs("/home/LHCB-T3/espedicato/tesi/calthEcore.png");
...
c5->SaveAs("/home/LHCB-T3/espedicato/tesi/calth_el.png"); 
...
c5MCS->SaveAs("/home/LHCB-T3/espedicato/tesi/calth_elMCS.png"); 
  ...
  /*  TCanvas * theC= new TCanvas("tar","tar",1500,1000,3500,2000);
    ...
    theC->SaveAs("/home/LHCB-T3/espedicato/tesi/calTh_el_XZYZ.png");     */
    ...
    the2->SaveAs("/home/LHCB-T3/espedicato/tesi/calthxzyz.png");   
}