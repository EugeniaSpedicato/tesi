...
c5->cd(2);
The_true1->SetLineColor(kOrange);
...
gPad->BuildLegend(0.3,0.21,0.3,0.21);
c5->cd(3);
The_true2->SetLineColor(kOrange);
...
c5MCS->Divide(1,3);
c5MCS->cd(1);
The_trueCUT->SetLineColor(kOrange);
...
gPad->BuildLegend(0.3,0.21,0.3,0.21);
c5MCS->cd(2);
The_trueCUT1->SetLineColor(kOrange);
...
gPad->BuildLegend(0.3,0.21,0.3,0.21);
c5MCS->cd(3);
The_trueCUT2->SetLineColor(kOrange);
...
c5MCS->SaveAs("/home/LHCB-T3/espedicato/tesi/th_elMCS.png"); 
    ...
    hist_thxz_e2->SetLineColor(kOrange);
    ...
    hist_thyz_e2->SetLineColor(kOrange);
    ...
    hist_thxz_e2BIG->SetLineColor(kOrange);
    ...
    hist_thyz_e2BIG->SetLineColor(kOrange);
    ...
    hist_thxz_e22P->SetLineColor(kOrange);
    ...
    hist_thyz_e22P->SetLineColor(kOrange);
