...
//if(r_mu<1.5 && E_clus3x3>3) The_trueCUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<1.5 && E_clus3x3>3) The_trueCUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
...
//if(r_mu<1.5 && E_clus3x3>3) The_trueCUT1Ee->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<1.5 && E_clus3x3>3) The_trueCUT1tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
...
//if(r_mu<1.5 && E_clus3x3>3) The_trueCUT2Ee->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<1.5 && E_clus3x3>3) The_trueCUT2tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
...
//if(r_mu<1.5 && E_clus3x3>3) TheCUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<1.5 && E_clus3x3>3)
...
//if(r_mu<1.5 && E_clus3x3>3) The1CUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<1.5 && E_clus3x3>3)The1CUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
...
//if(r_mu<1.5 && E_clus3x3>3) E3x31CUTEe->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);
if(r_mu<1.5 && E_clus3x3>3) E3x31CUTtot->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);
} }
    if (detKinBeamRot_tar==1)
...
//if(r_mu<1.5 && E_clus3x3>3) The2CUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<1.5 && E_clus3x3>3)The2CUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
     if (E_clus3x3!=0) 
     {
...
//if(r_mu<1.5 && E_clus3x3>3) E3x32CUTEe->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);
if(r_mu<1.5 && E_clus3x3>3) E3x32CUTtot->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);
} 
