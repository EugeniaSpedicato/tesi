...
if(r_mu<3 && detKinBeamRot_Ee>1) The_trueCUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_Ee>1) The_trueCUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
...
if(r_mu<3 && detKinBeamRot_Ee>1) The_trueCUT1Ee->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_Ee>1) The_trueCUT1tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
...
if(r_mu<3 && detKinBeamRot_Ee>1) The_trueCUT2Ee->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_Ee>1) The_trueCUT2tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
...
if(r_mu<3 && detKinBeamRot_Ee>1) TheCUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_Ee>1)TheCUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
...
if(r_mu<3 && detKinBeamRot_Ee>1) The1CUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_Ee>1)The1CUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
    if (detKinBeamRot_tar==1)
...
if(r_mu<3 && detKinBeamRot_Ee>1) The2CUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_Ee>1)The2CUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);} /*else { 
