...
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_E_clus3x3>1) The_trueCUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
...
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_E_clus3x3>1) The_trueCUT1tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
...
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_E_clus3x3>1) The_trueCUT2tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
...
if(r_mu<3 && detKinBeamRot_def_angle_mu>0.2 && detKinBeamRot_E_clus3x3>1)TheCUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
...
E3x32->Draw("COLZ");
c4a->cd(3);   
E3x3CUT1->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUT1->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUT1->Draw("COLZ");
c4a->cd(4);   
E3x3CUT2->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUT2->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUT2->Draw("COLZ");
c4a->cd(5);   
E3x3CUTmu1->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUTmu1->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUTmu1->Draw("COLZ");
c4a->cd(6);   
E3x3CUTmu2->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUTmu2->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUTmu2->Draw("COLZ");
c4a->cd(7);   
E3x3CUTEe1->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUTEe1->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUTEe1->Draw("COLZ");
c4a->cd(8);   
E3x3CUTEe2->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUTEe2->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUTEe2->Draw("COLZ");
c4a->cd(9);   
E3x3CUTtot1->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUTtot1->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUTtot1->Draw("COLZ");
c4a->cd(10);   
E3x3CUTtot2->GetXaxis()->SetTitle("Theta_el[mrad]");
E3x3CUTtot2->GetYaxis()->SetTitle("Ereco3x3[GeV]");
E3x3CUTtot2->Draw("COLZ");
