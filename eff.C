...
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3) The_trueCUTmu->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_Ee>1) The_trueCUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3 && detKinBeamRot_Ee>1) The_trueCUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
    

    if (detKinBeamRot_tar==0)
    {The_true1->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5) The_trueCUT1->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3) The_trueCUT1mu->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_Ee>1) The_trueCUT1Ee->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3 && detKinBeamRot_Ee>1) The_trueCUT1tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
    if (detKinBeamRot_tar==1)
    {The_true2->Fill(detKinBeamRot_def_angle_e,wgt_full);
     
if(r_mu<5) The_trueCUT2->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3) The_trueCUT2mu->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_Ee>1) The_trueCUT2Ee->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3 && detKinBeamRot_Ee>1) The_trueCUT2tot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
...
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3) TheCUTmu->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_Ee>1) TheCUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3 && detKinBeamRot_Ee>1)TheCUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);
    
    if (detKinBeamRot_tar==0)
    {The1->Fill(detKinBeamRot_def_angle_e,wgt_full);
     
if(r_mu<5) The1CUT->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3) The1CUTmu->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_Ee>1) The1CUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3 && detKinBeamRot_Ee>1)The1CUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);}
    if (detKinBeamRot_tar==1)
    {The2->Fill(detKinBeamRot_def_angle_e,wgt_full);
     
if(r_mu<5) The2CUT->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3) The2CUTmu->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_Ee>1) The2CUTEe->Fill(detKinBeamRot_def_angle_e,wgt_full);
if(r_mu<5 && detKinBeamRot_def_angle_mu>0.3 && detKinBeamRot_Ee>1)The2CUTtot->Fill(detKinBeamRot_def_angle_e,wgt_full);} /*else { 
