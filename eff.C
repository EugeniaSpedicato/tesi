...
if(detKinBeamRot_def_angle_mu>0.2) The_trueCUT->Fill(detKinBeamRot_def_angle_e,wgt_full);
...
if(abs(detKinBeamRot_cooXe)<4.275 && abs(detKinBeamRot_cooYe)<4.275) {
    ...
    if(detKinBeamRot_def_angle_mu>0.2) TheCUT->Fill(detKinBeamRot_def_angle_e,wgt_full);
    
    if (detKinBeamRot_tar==0)
    {The1->Fill(detKinBeamRot_def_angle_e,wgt_full);
    if(detKinBeamRot_def_angle_mu>0.2) The1CUT->Fill(detKinBeamRot_def_angle_e,wgt_full);}
    if (detKinBeamRot_tar==1)
    {The2->Fill(detKinBeamRot_def_angle_e,wgt_full);
    if(detKinBeamRot_def_angle_mu>0.2) The2CUT->Fill(detKinBeamRot_def_angle_e,wgt_full);}
