...
TH2F  *X_Y_p  = new TH2F("h2da" , " X  Vs. y of the photon",140,-0.5,-0.5,140,-0.5,0.5);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      nb = fChain->GetEntry(jentry);   nbytes += nb;
       ...
       if (detKinBeamRot.cooXe > 0.07 || detKinBeamRot.cooYe > 0.07 || detKinBeamRot.cooXe < -0.07 || detKinBeamRot.cooYe < -0.07 || detKinBeamRot.cooXmu > 0.07 || detKinBeamRot.cooYmu > 0.07 || detKinBeamRot.cooXmu < -0.07 || detKinBeamRot.cooYmu < -0.07 || photon.coox > 0.07 || photon.cooy > 0.07 || photon.coox < -0.07 || photon.cooy < -0.07){ 
