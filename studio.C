...
TH2F  *E3x31CUT  = new TH2F("ThEel1" , " Th_el Vs. E_E3x3 core NLO CUT",180,0,30,360,0,140);
TH2F  *E3x32CUT  = new TH2F("ThEel2" , " Th_el Vs. E_E3x3 core LO CUT",180,0,30,360,0,140);
...
int SecondCentralCell=0;
 for(int i=0; i<9; ++i)
{          
if (SecondCentralCell==Array9[i] && SecondCentralCell!=0)
    {//++sec_9;
    SecondCentralCell=SecondCentralCell;
    SecondCentralCell=0;
    break;} 
else continue;
}
...
if(E_clus3x3>1)//&& detKinBeamRot_def_angle_mu>0.2  && E_clus3x3>1
{
if (E_clus3x3!=0){E3x31CUT->Fill(detKinBeamRot_def_angle_e,E_clus3x3,wgt_full);} 
...
//else if (SecondCentralCell!=0){sec_9+=wgt_full;energy->Fill(Eout,wgt_full);}
