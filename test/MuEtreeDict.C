...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MuE::Photon*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MuE::Photon", ::MuE::Photon::Class_Version(), "MuEana.h", 45,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MuE::MuEana*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MuE::MuEana", ::MuE::MuEana::Class_Version(), "MuEana.h", 62,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<MuE::P4>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<MuE::P4>", -2, "vector", 470,
...
"../code",
"/Applications/root_v6.20.00/include/",
"/Users/eugenia/Desktop/MuE_v19_gitlabll/test/",
0
    };
