...
CXXFLGS=`$ROOTSYS/root-config --cflags'
...
g++ ${OPTIONS} -I${code} -I${ROOTINCDIR} -I${ROOTLIBS} -I${CXXFLGS} ${code}/${MAIN}.cc MuEtreeDict.C ${code}/MuEtree.cc ${code}/Inputs.cc ${code}/Analysis.cc ${code}/FastSim.cc ${code}/Utils.cc ${code}/ElasticState.cc ${code}/dalpha.cc ${code}/ECAL.cc ${code}/EMShower.cc ${code}/RadialInterval.cc ${code}/GammaFunctionGenerator.cc ${code}/BaseNumericalRandomGenerator.cc ${code}/IncGamma.cc
