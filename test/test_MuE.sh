...
g++ ${OPTIONS} -I${code} -I${ROOTINCDIR} ${code}/${MAIN}.cc MuEtreeDict.C ${code}/MuEtree.cc ${code}/Inputs.cc ${code}/Analysis.cc ${code}/FastSim.cc ${code}/Utils.cc ${code}/ElasticState.cc ${code}/Histos.cc ${code}/dalpha.cc summa.o hadr5n12.o muerad.o ${ROOTLIBS} -L/opt/local/include/X11/ -lgfortran -lX11 -o ${MAIN}.exe
